...
_via_view_manager.prototype._on_add_media_local = function (status) {
	_via_util_file_select_local(
		_VIA_FILE_SELECT_TYPE.IMAGE |
			_VIA_FILE_SELECT_TYPE.VIDEO |
			_VIA_FILE_SELECT_TYPE.AUDIO,
		this._file_add_local.bind(this, status),
		true
	);
};

_via_view_manager.prototype._file_add_local = function (status, e) {
...
_via_view_manager.prototype._on_add_media_bulk_file_load = function (
	file_data
) {
